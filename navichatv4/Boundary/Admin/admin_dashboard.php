...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['feedback_id']) && isset($_POST['status'])) {
    ...
    $feedbackController->updateFeedbackStatus($feedbackId, $status);
}
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="#" class="menu-item" data-section="feedback-management">Feedback Management</a>
        ...
        <table>
            ...
            <tbody>
                ...
                if (empty($allFeedback)): ?>
                    <tr>
                        <td colspan="5" class="no-record">No feedback submissions yet...</td>
                    </tr>
                <?php else:
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" class="status-form">
                                    ...
                                    <select name="status" onchange="this.form.submit()" class="status-select <?= $feedback['status'] ?>">
