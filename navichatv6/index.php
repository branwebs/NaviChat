...
<body>
 ...
 -->
    ...
    <!-- Pricing -->
    <section class="white-section text-center" id="pricing">
        <h2 class="section-heading">Our Subscription Plan</h2>
        <p>Simple plan with all the features!</p>
        <div class="d-flex justify-content-center">
            <?php
            $pricingQuery = "SELECT tier, price, features FROM Pricing LIMIT 1";
            $pricingResult = $conn->query($pricingQuery);

            if ($pricingResult->num_rows > 0) {
                $row = $pricingResult->fetch_assoc();
                echo '<div class="pricing-column col-lg-4">';
                echo '<div class="card">';
